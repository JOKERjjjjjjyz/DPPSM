...
if [ "$data" == "cityday" ]; then
    DATA=(
        ...
        "/home/guest/zsf/jyz/montecarlopwd/result/nn_distinct/rock-city-dpsgd-0.2197.csv" \
    ...
    DATA=(
        ...
        "/home/guest/zsf/jyz/montecarlopwd/result/nn_distinct/rock2019-rock2024-dpsgd-0.2197.csv" \
...
--suffix .pdf                               \
-s ${BASE}/figure/DPPSM/$data"_dpfla_result.pdf"               \
-x 'Guesses'                               \
-y 'Cracked (%)'                            \
--show-text                                 \
--xtick-direction 'in'                      \
