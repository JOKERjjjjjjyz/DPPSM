...
if [ "$data" == "cityday" ]; then
    DATA=(
        ...
        # "/home/guest/zsf/jyz/montecarlopwd/result/rock-city-adaptive-xx.csv" \
    ...
    DATA=(
        ...
        # "/home/guest/zsf/jyz/montecarlopwd/result/rock2019-rcok2024-adaptive-xx.csv" \
...
--suffix .pdf                               \
-s ${BASE}/figure/DPPSM/$data"_dpbackoff_baseline_result.pdf"               \
-x 'Guesses'                               \
-y 'Cracked (%)'                            \
--show-text                                 \
--legend-loc 'none'                   \
