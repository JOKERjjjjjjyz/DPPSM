...
checkpoint = torch.load("./models/model/rockyou10w_dpsgd_1.29.pth")
...
preprocessor = Preprocessor(config_path=config_path)
n_samples = 1000
montecarlo_estimator = MonteCarloEstimator(model=model, preprocessor=preprocessor, n_samples=n_samples, estimator_file='rockyou10w_dpsgd_1.29_estimator.pkl')
...
test_file = "./data/test/test.txt"  # 应替换为实际测试文件
result_file = "./results/rockyou10w_results_dpsgd_1.29.csv"
