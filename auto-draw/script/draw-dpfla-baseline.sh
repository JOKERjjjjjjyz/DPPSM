...
# MINAUTO_OUTPUT=${BASE}/result/minauto-$data.txt

#  "/disk/xm/subword-markov/result_backoff/"$data"1.5.txt" \
# "/disk/xm/subword-markov/result_backoff/"$data"1.2.txt" \
# "/disk/xm/lstm/"$data".txt" \
# "/home/xm/test/result+/rocomen_4/"$data"__result.txt" \
...
if [ "$data" == "cityday" ]; then
    DATA=(
        ...
        "/home/guest/zsf/jyz/montecarlopwd/result/nn_distinct/rock-city-dpsgd-0.9807.csv" \
    ...
    DATA=(
        ...
        "/home/guest/zsf/jyz/montecarlopwd/result/nn_distinct/rock2019-rock2024-dpsgd-0.9807.csv" \
...
--suffix .pdf                               \
-s ${BASE}/figure/DPPSM/$data"_dpfla_baseline_result.pdf"               \
-x 'Guesses'                               \
-y 'Cracked (%)'                            \
--show-text                                 \
--legend-loc 'none'                   \
