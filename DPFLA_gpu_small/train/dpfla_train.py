...
class DPTrainer:
    def __init__(self, config_path, data_path):
        ...
        self.model_save_path = './models/model/rockyou320w_dpfla_0.1178.pth'
        ...
        self.noise_multiplier_account = 3.0
    ...
    def train(self):
        for epoch in range(self.epoch_size):
            ...
            if (epoch+1) % 5 == 0:
                os.makedirs(os.path.dirname(f"./models/model/rockyou320w_dpfla_0.1178_{epoch}.pth"), exist_ok=True)
                torch.save(self.model.state_dict(), f"./models/model/rockyou320w_dpfla_0.1178_{epoch}.pth")
                print(f"Model saved to ./models/model/rockyou320w_dpfla_0.1178_{epoch}.pth")
